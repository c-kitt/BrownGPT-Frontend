...
export const InitialPrompts = ({ onPromptClick }: InitialPromptsProps) => {
  const prompts = [
    {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-[hsl(var(--brown-dark))] mb-2 font-sans">
          How can I help, Bear?
        </h1>
      ...
      <div className="grid gap-4">
        {prompts.map((prompt, index) => (
          <Card key={index} className="p-0 overflow-hidden border border-[hsl(var(--brown-dark))] hover:shadow-md transition-shadow">
            <Button
              onClick={() => onPromptClick(prompt.title)}
              variant="ghost"
              className="w-full h-auto p-6 justify-start text-left hover:bg-[hsl(var(--brown-light))]"
            >
